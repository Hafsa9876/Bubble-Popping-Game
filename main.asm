...
clrscr:
	...
	pop es
	ret
			printnum: push bp                        ;printing score
		 mov bp, sp
		 push es
		 push ax
		 push bx
		...
		nextdigit: mov dx, 0 ; zero upper half of dividend
		 ...
		 mov di, 2262 ; point di to top left column
